...
export declare function evaluate(exp: ASTStatement, exportEnv: Environment, pid: number, _path: string, onExit?: (code: number) => void, onError?: (err: Error) => void): Promise<any>;
